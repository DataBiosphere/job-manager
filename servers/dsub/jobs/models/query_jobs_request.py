...
class QueryJobsRequest(Model):
    ...
    """
    def __init__(self, start=None, end=None, statuses=None, labels=None, name=None, page_size=None, page_token=None, extended_query_fields=None):
        """
        ...
        :type page_token: str
        :param extended_query_fields: The extended_query_fields of this QueryJobsRequest.
        :type extended_query_fields: ExtendedQueryFields
        """
        self.swagger_types = {
            'start': datetime,
            'end': datetime,
    ...
    def extended_query_fields(self):
        """
        Gets the extended_query_fields of this QueryJobsRequest.

        :return: The extended_query_fields of this QueryJobsRequest.
    ...
    def extended_query_fields(self, extended_query_fields):
        """
        Sets the extended_query_fields of this QueryJobsRequest.
