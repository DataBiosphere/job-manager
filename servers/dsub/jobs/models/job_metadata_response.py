...
class JobMetadataResponse(Model):
    ...
    """
    def __init__(self, id=None, status=None, submission=None, name=None, start=None, end=None, inputs=None, outputs=None, labels=None, tasks=None, stdout=None, stderr=None, failures=None):
        """
        ...
        :param stdout: The stdout of this JobMetadataResponse.
        :type stdout: str
        :param stderr: The stderr of this JobMetadataResponse.
        :type stderr: str
    ...
    def stdout(self):
        """
        Gets the stdout of this JobMetadataResponse.
        Path to the standard output file for this job

        :return: The stdout of this JobMetadataResponse.
        :rtype: str
        """
        return self._stdout
    ...
    def stdout(self, stdout):
        """
        Sets the stdout of this JobMetadataResponse.
        Path to the standard output file for this job
    ...
    def stderr(self):
        """
        Gets the stderr of this JobMetadataResponse.
        Path to the standard error file for this job

        :return: The stderr of this JobMetadataResponse.
        :rtype: str
        """
        return self._stderr
    ...
    def stderr(self, stderr):
        """
        Sets the stderr of this JobMetadataResponse.
        Path to the standard error file for this job
