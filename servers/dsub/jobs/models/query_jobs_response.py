...
class QueryJobsResponse(Model):
    ...
    """
    def __init__(self, results=None, total_size=None, next_page_token=None):
        """
        ...
        :param total_size: The total_size of this QueryJobsResponse.
    ...
    def total_size(self, total_size):
        """
        Sets the total_size of this QueryJobsResponse.
        The total number of results which matched the query. Can be empty if the backend cannot calculate this total.
