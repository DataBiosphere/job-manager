...
class TaskMetadata(Model):
    ...
    """
    def __init__(self, inputs=None, execution_status=None, start=None, end=None, name=None, job_id=None, failures=None, return_code=None, stdout=None, stderr=None, attempts=None, subworkflow_id=None):
        """
        ...
        :type attempts: int
        :param subworkflow_id: The subworkflow_id of this TaskMetadata.
        :type subworkflow_id: str
        """
        self.swagger_types = {
            'inputs': object,
        ...
        self._subworkflow_id = subworkflow_id
    ...
    @property
    def subworkflow_id(self):
        """
        Gets the subworkflow_id of this TaskMetadata.
        Id of the workflow corresponding to the task, if the task is a subworkflow

        :return: The subworkflow_id of this TaskMetadata.
        :rtype: str
        """
        return self._subworkflow_id

    @subworkflow_id.setter
    def subworkflow_id(self, subworkflow_id):
        """
        Sets the subworkflow_id of this TaskMetadata.
        Id of the workflow corresponding to the task, if the task is a subworkflow
