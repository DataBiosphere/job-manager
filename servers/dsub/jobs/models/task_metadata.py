...
class TaskMetadata(Model):
    ...
    """
    def __init__(self, inputs=None, execution_status=None, start=None, end=None, name=None, execution_id=None, failures=None, return_code=None, stdout=None, stderr=None, attempts=None, call_root=None, job_id=None, shard_statuses=None):
        """
        ...
        :type name: str
        :param execution_id: The execution_id of this TaskMetadata.
        ...
        :type attempts: int
        :param call_root: The call_root of this TaskMetadata.
        :type call_root: str
        :param job_id: The job_id of this TaskMetadata.
        :type job_id: str
        :param shard_statuses: The shard_statuses of this TaskMetadata.
        :type shard_statuses: List[ShardStatusCount]
        """
        self.swagger_types = {
            'inputs': object,
            ...
            'call_root': str,
            'job_id': str,
            'shard_statuses': List[ShardStatusCount]
        }
        ...
        self._job_id = job_id
        self._shard_statuses = shard_statuses
    ...
    def execution_id(self):
        """
        Gets the execution_id of this TaskMetadata.
        Backend-specific job ID

        :return: The execution_id of this TaskMetadata.
        :rtype: str
        """
    ...
    def execution_id(self, execution_id):
        """
        Sets the execution_id of this TaskMetadata.
        Backend-specific job ID
    ...
    def call_root(self):
        """
        Gets the call_root of this TaskMetadata.
        The root directory of the task execution

        :return: The call_root of this TaskMetadata.
        :rtype: str
        """
    ...
    def call_root(self, call_root):
        """
        Sets the call_root of this TaskMetadata.
        The root directory of the task execution
    ...
    def shard_statuses(self):
        """
        Gets the shard_statuses of this TaskMetadata.

        :return: The shard_statuses of this TaskMetadata.
        :rtype: List[ShardStatusCount]
        """
        return self._shard_statuses

    @shard_statuses.setter
    def shard_statuses(self, shard_statuses):
        """
        Sets the shard_statuses of this TaskMetadata.
