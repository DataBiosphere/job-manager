...
class JobMetadataResponse(Model):
    ...
    """
    def __init__(self, id=None, status=None, submission=None, name=None, start=None, end=None, inputs=None, outputs=None, labels=None, logs=None, tasks=None, failures=None):
        """
        ...
        :type labels: object
        :param logs: The logs of this JobMetadataResponse.
        :type logs: object
    ...
    def logs(self):
        """
        Gets the logs of this JobMetadataResponse.
        Map of type of log file to its location

        :return: The logs of this JobMetadataResponse.
        :rtype: object
        """
        return self._logs
    ...
    def logs(self, logs):
        """
        Sets the logs of this JobMetadataResponse.
        Map of type of log file to its location
