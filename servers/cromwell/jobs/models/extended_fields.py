...
class ExtendedFields(Model):
    ...
    """
    def __init__(self, user_id=None, status_detail=None, logs=None, last_update=None, envs=None, script=None, parent_job_id=None, timing_url=None, tasks=None):
        """
        ...
        :type envs: object
        :param script: The script of this ExtendedFields.
        :type script: str
    ...
    def script(self):
        """
        Gets the script of this ExtendedFields.
        The text of the script executed by this job.

        :return: The script of this ExtendedFields.
        :rtype: str
        """
        return self._script
    ...
    def script(self, script):
        """
        Sets the script of this ExtendedFields.
        The text of the script executed by this job.
