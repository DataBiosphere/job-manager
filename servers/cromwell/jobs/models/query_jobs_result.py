...
class QueryJobsResult(Model):
    ...
    """
    def __init__(self, id=None, name=None, status=None, submission=None, start=None, end=None, labels=None, extended_fields=None):
        """
        ...
        :type labels: object
        :param extended_fields: The extended_fields of this QueryJobsResult.
    ...
    def extended_fields(self):
        """
        Gets the extended_fields of this QueryJobsResult.

        :return: The extended_fields of this QueryJobsResult.
    ...
    def extended_fields(self, extended_fields):
        """
        Sets the extended_fields of this QueryJobsResult.
