...
class TaskMetadata(Model):
    ...
    """
    def __init__(self, inputs=None, execution_status=None, start=None, end=None, name=None, execution_id=None, failures=None, return_code=None, stdout=None, stderr=None, attempts=None, job_id=None):
        """
